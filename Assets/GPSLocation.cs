...
public class GPSLocation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(latitud>(-16.50605-0.00010)&& latitud<(-16.50423+0.00010) && longitud>(-68.20822-0.00010) && longitud<(-68.20822+0.00010)){
            placeText.text = "Ubicación de la Familia Gutierrez // Z. Pedro Domingo Murillo C. Pedro Rodriguez Murillo";
